...
public class GenerateurGraphes {
    ...
    public static Graphe creerPetiteCommune() {
        ...
        Sommet e = new Sommet("E", "Centre commercial", 7.9);
        Sommet f = new Sommet("F", "Gare", 2.6);
        Sommet gg = new Sommet("G", "Parc", 1.8);
        ...
        g.ajouterArete(new Arete(f, gg, 1.4));
        g.ajouterArete(new Arete(gg, b, 1.6));
        return g;
    }
    ...
    public static Graphe creerGrandeCommune() {
        ...
        // 15 sommets + mixte + sens uniques – exemple réaliste
        // (Tu peux copier un graphe plus grand ou je te l’envoie complet)
        return g; // À compléter si tu veux
    }
}